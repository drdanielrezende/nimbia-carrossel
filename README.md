...
**Nimbia Carrossel** é um gerador gratuito de carrosséis com agentes de IA, criado para ajudar médicos a transformar conhecimento clínico em conteúdos educativos, éticos e visualmente organizados para redes sociais.

A proposta é facilitar a criação de posts médicos com linguagem acessível, estrutura clara e cuidado com boas práticas de comunicação em saúde.
...
* Criação de gancho inicial;
* Organização dos slides;
* Simplificação da linguagem;
* Sugestão de títulos;
* Estruturação de legenda;
* Sugestão de chamada para ação;
* Revisão de tom e clareza;
* Apoio à comunicação ética em saúde.
...
Todo conteúdo gerado deve ser revisado pelo profissional antes da publicação.
